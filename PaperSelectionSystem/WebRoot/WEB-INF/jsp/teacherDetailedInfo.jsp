  ...
  <body>
	...
	<div class="main">
		<div class="content">
			...
			<p align="center" style="font-size:25px">教师详细信息
				<table align = "center">
					<tr> 
						<td><p>教师ID:</td>
				...
				<c:forEach items="${teacherCourseList}" var="teacherCourse" varStatus="vs">  
	       		 	<tr>      
		             <td align = "center">${teacherCourse.course_id}</td>  
		             <td align = "center">${teacherCourse.course_name}</td> 
		             <td align = "center">${teacherCourse.term}</td> 
		             <td align = "center">${teacherCourse.identify}</td> 
		             <td align = "center">${teacherCourse.teach_hour}</td> 
					<td align="right"><a href="编辑教师所授课程?tc_id=${teacherCourse.tc_id}&teacher_id=${teacher.teacher_id}">编辑</a></td>
	        	 	</tr>
				</c:forEach> 
				</table>	
